    ...
    <header class='bg-transparent navbar-fixed top-0 left-0 w-full flex items-center z-10'>
        <div class='container'>
            <div class="flex items-center justify-between relative">
                <div class="px-4">
                    <a href="#home" class="font-bold text-lg block py-6"><img
                            src="@/assets/web.dc49fee7.png"
                            alt="Logo Dinas Pendidikan Provinsi Jawa Barat" style="width: 8rem;"></a>
                </div>
