            ...
            <div class="flex flex-wrap">
                <div class="w-full md:w-1/2">
                    <div class="flex items-center space-x-6">
                        <div class="relative">
                            <!-- Foto Profil -->
                            <img alt="Profile picture" class="w-32 h-32 rounded-full block border" height="150"
                                :src="previewPhoto || akun.photo_url" width="150" />

                            <!-- Overlay untuk Upload -->
                            <div class="absolute w-full h-full top-0 left-0 flex items-center justify-center opacity-0 rounded-full 
                    hover:opacity-100 bg-black bg-opacity-50 text-gray-100 transition ease-in-out duration-500">
