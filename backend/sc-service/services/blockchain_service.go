...
// IJAZAH BLOCKCHAIN
// =====================================
func (s *BlockchainService) CreateIjazahBlockchain(ctx context.Context, req *pb.CreateIjazahBlockchainRequest) (*pb.CreateIjazahBlockchainResponse, error) {
...
func (s *BlockchainService) GetIjazahBlockchain(ctx context.Context, req *pb.GetIjazahBlockchainRequest) (*pb.GetIjazahBlockchainResponse, error) {
	// var err error
	// // Daftar field yang wajib diisi
...
func (s *BlockchainService) SearchIjazahBlockchain(ctx context.Context, req *pb.SearchIjazahBlockchainRequest) (*pb.SearchIjazahBlockchainResponse, error) {
