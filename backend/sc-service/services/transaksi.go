...
// 		ID:                          uuid.New(),
// 		PesertaDidikID:              degreeData.PesertaDidikId,
// 		Nama:                        degreeData.Nama,
// 		NIS:                         degreeData.NIS,
// 		NISN:                        degreeData.NISN,
// 		TempatLahir:                 degreeData.TptLahir,
// 		AsalSekolah:                 degreeData.AsalSekolah,
...
// 	}
// 	ijazahBc := s.repoIjazahBc(ctx, "public", utils.SliceToPointer(ijazahBcModels), 100)
// 	if ijazahBc != nil {
// 		return nil, err
// 	}
