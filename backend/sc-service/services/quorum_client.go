...
// 	_, err := q.client.NetworkID(context.Background())
// 	if err != nil {
...
// // 	return q.client.CallContractMethod(ctx, contractAddress, abi, method, params)
// // }
...
// // //		return q.client.GetTokenBalance(ctx, tokenAddress, ownerAddress)
// // //	}
...
// // 	return q.client.DeployContract(ctx, bytecode, privateKey, gasLimit)
// // }
...
// // 	return q.client.GetContractEvents(ctx, contractAddress, abi, eventName, fromBlock, toBlock)
// // }
// // func (q *QuorumClient) SendETH(ctx context.Context, privateKeyHex, toAddress string, amount *big.Int) (string, error) {
// // 	return q.client.SendETH(ctx, privateKeyHex, toAddress, amount)
// // }
