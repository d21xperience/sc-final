...
// **CreateIjazah**
func (s *NilaiAkhirServiceServer) CreateIjazah(ctx context.Context, req *pb.CreateIjazahRequest) (*pb.CreateIjazahResponse, error) {
...
// **GetIjazah**
func (s *NilaiAkhirServiceServer) GetIjazah(ctx context.Context, req *pb.GetIjazahRequest) (*pb.GetIjazahResponse, error) {
	schemaName := req.GetSchemaname()
...
// **UpdateIjazah**
func (s *NilaiAkhirServiceServer) UpdateIjazah(ctx context.Context, req *pb.UpdateIjazahRequest) (*pb.UpdateIjazahResponse, error) {
...
// // **DeleteIjazah**
func (s *NilaiAkhirServiceServer) DeleteIjazah(ctx context.Context, req *pb.DeleteIjazahRequest) (*pb.DeleteIjazahResponse, error) {
	schemaName := req.GetSchemaname()
	IjazahID := req.GetIjazahId()
