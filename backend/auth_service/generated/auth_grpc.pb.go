...
const (
	...
	AuthService_GetSekolahByNpsn_FullMethodName = "/auth.AuthService/GetSekolahByNpsn"
...
type AuthServiceClient interface {
	...
	GetSekolahByNpsn(ctx context.Context, in *GetSekolahByNpsnRequest, opts ...grpc.CallOption) (*GetSekolahByNpsnResponse, error)
...
func (c *authServiceClient) GetSekolahByNpsn(ctx context.Context, in *GetSekolahByNpsnRequest, opts ...grpc.CallOption) (*GetSekolahByNpsnResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetSekolahByNpsnResponse)
	err := c.cc.Invoke(ctx, AuthService_GetSekolahByNpsn_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	GetSekolahByNpsn(context.Context, *GetSekolahByNpsnRequest) (*GetSekolahByNpsnResponse, error)
...
func (UnimplementedAuthServiceServer) GetSekolahByNpsn(context.Context, *GetSekolahByNpsnRequest) (*GetSekolahByNpsnResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSekolahByNpsn not implemented")
}
...
func _AuthService_GetSekolahByNpsn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSekolahByNpsnRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetSekolahByNpsn(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GetSekolahByNpsn_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetSekolahByNpsn(ctx, req.(*GetSekolahByNpsnRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSekolahByNpsn",
			Handler:    _AuthService_GetSekolahByNpsn_Handler,
		},
		{
